            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="navigator-breadcrumb-wrapper">
                        ...
                        <a class="current" href="{{ route('user-dashboard') }}">Account</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="nav accout-dashborard-nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <button class="nav-link" id="v-pills-settingsb-tab" data-bs-toggle="pill" data-bs-target="#v-pills-settingsb" type="button" role="tab" aria-controls="v-pills-settingsb" aria-selected="false"><a href="{{ route('website-auth-logout') }}"><i class="fa-light fa-right-from-bracket"></i>log Out</a></button>
                    </div>
                </div>
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab" tabindex="0">
                            <div class="dashboard-account-area">
                                <h2 class="title">Hello {{ Session::get('user')->name }}! </a></h2>
                                <p class="disc">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $order->status }}</td>
                                                <td>£{{ $order->amount }}</td>
                                                <td><a href="account.html#" class="btn-small d-block">View</a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                        ...
                        <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab" tabindex="0">
                            <div class="tracing-order-account">
                                ...
                                <form action="account.html#" class="order-tracking">
                        ...
                        <div class="tab-pane fade" id="v-pills-settingsa" role="tabpanel" aria-labelledby="v-pills-settingsa-tab" tabindex="0">
                            <form action="" class="account-details-area">
                                ...
                                <input type="email"  name="eamil" placeholder="Email Address *" required>
