                            ...
                            <div class="single-cart-area-list main item-parent">
                                <div class="product-main-cart">
                                    ...
                                    <div class="information">
                                        ...
                                        <span>Weight: {{ $item->product->variation }}</span>
                                    </div>
                                </div>
                                <div class="price">
                                    <p>
                                        ...
                                        £{{ number_format($item->product->variationPrice['selling_price'], 2) }}
                                ...
                                <div class="subtotal">
                                    <p wire:loading.class="opacity-50">£{{ number_format($item->product->variationPrice['selling_price'] * $item->qty, 2) }}</p>
                                </div>
                            </div>
                            @endforeach
