                                        ...
                                        <div class="contents">
                                            ...
                                            <div class="variation-selector mb--20">
                                                <div class="d-flex align-items-center" style="gap: 10px;">
                                                    <!-- Label -->
                                                    <label for="variation" style="font-weight: 500; margin-bottom: 0;">Select Variation:</label>
                                                    
                                                    <!-- Select Dropdown -->
                                                    <select id="variation" class="form-select" style="width: auto;" wire:model="selectedVariation">
                                    ...
                                    <div class="single-tab-content-shop-details">
                                        <div class="product-details-review-product-style">
                                            ...
                                            <div class="submit-review-area">
                                                <form action="shop-details.html#" class="submit-review-area">
                    ...
                    <div class="category-area-main-wrapper-one">
                        <div class="swiper mySwiper-category-1 swiper-data" data-swiper='{
                            ...
                            <div class="swiper-wrapper">
                                @forelse($related_products as $relatedProduct)
                                <div class="swiper-slide">
                                    <div class="single-shopping-card-one">
                                        <!-- image and action area start -->
                                        <div class="image-and-action-area-wrapper">
                                            <a href="{{ route('website-product-detail', $relatedProduct->slug) }}" class="thumbnail-preview">
                                                @if($relatedProduct->discount_percentage > 0)
                                                <div class="badge">
                                                    <span>{{ $relatedProduct->discount_percentage }}% <br>Off</span>
                                                    <i class="fa-solid fa-bookmark"></i>
                                                </div>
                                                @endif
                                                <img src="{{ env('PRODUCT_IMAGE_URL') . $relatedProduct->featured_image }}" alt="{{ $relatedProduct->name }}">
                                            </a>
                                            <div class="action-share-option">
                                                <div class="single-action openuptip message-show-action" 
                                                    ...
                                                    <i class="fa-{{ $relatedProduct->isWishlisted ? 'solid' : 'light' }} fa-heart"></i>
                                                </div>
                                                <div class="single-action openuptip" 
                                                     data-flow="up" 
                                                     title="Compare" 
                                                     wire:click="addToCompare({{ $relatedProduct->id }})">
                                        ...
                                        <div class="body-content">
                                            <div class="time-tag">
                                                ...
                                                {{ $relatedProduct->preparation_time ?? '9' }} MINS
                                            </div>
                                            <a href="{{ route('website-product-detail', $relatedProduct->slug) }}">
                                                <h4 class="title">{{ $relatedProduct->name }}</h4>
                                            </a>
                                            <span class="availability">{{ $relatedProduct->unit }}</span>
                                            <div class="price-area">
                                                <span class="current">${{ number_format($relatedProduct->selling_price, 2) }}</span>
                                                @if($relatedProduct->original_price > $relatedProduct->selling_price)
                                                    <div class="previous">${{ number_format($relatedProduct->original_price, 2) }}</div>
                                                @endif
                                            </div>
                                            <div class="cart-counter-action">
                                                <div class="quantity-edit">
                                                    <input type="text" class="input" wire:model="quantities.{{ $relatedProduct->id }}" />
                                                    <div class="button-wrapper-action">
                                                        <button class="button" wire:click="decrementRelatedQuantity({{ $relatedProduct->id }})">
                                                            <i class="fa-regular fa-chevron-down"></i>
                                                        </button>
                                                        <button class="button plus" wire:click="incrementRelatedQuantity({{ $relatedProduct->id }})">
