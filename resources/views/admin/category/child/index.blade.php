     ...
     <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card ">
            <div class="row card-header justify-content-end">
                <div class="col-md-4">
                    <a href="{{ route('admin-category-child-create',['id' => $parent_category->id])}}" class="btn btn-primary float-end">Create</a>
                </div>
            </div>
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            ...
                            <div class="dropdown">
                                ...
                                <a class="dropdown-item" href="{{ route('admin-category-child-update',['id' => $category->id,'parent_id' => $category->parent_id])}}"
