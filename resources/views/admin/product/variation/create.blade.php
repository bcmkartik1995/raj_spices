...
@section('title','Variation Create')
@section('content')
<div class="content-wrapper">
  <!-- Content -->

  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Variation/</span> Create</h4>
            ...
            <div class="row">
                  ...
                  <select class="form-select" name="variation_id" id="exampleFormControlSelect1" aria-label="Default select example">
                    <option value="">Select Variation</option>
                      @foreach (\App\Models\ProductVariation::variations() as $key => $variation)
                          <option value="{{ $key }}" {{ old('variation_id') == $key ? 'selected' : '' }}>
                              {{ $variation }}
                          </option>
                      @endforeach
                  </select>
              ...
              <div class="col-md-3">
                <div class="mb-3">
                  ...
                  <input class="form-control" type="number" name="quantity" id="formFile" />
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input class="form-control" type="number" name="original_price" id="formFile" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="formFile" class="form-label">Selling Price</label>
                  <input class="form-control" type="number" name="selling_price" id="formFile" />
                </div>
              </div>
            </div>
