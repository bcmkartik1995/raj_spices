            ...
            <div class="col-lg-6 mb-4 mb-xl-0">
              ...
              <div class="demo-inline-spacing mt-3">
                <div class="list-group">
                  ...
                  <a href="javascript:void(0);" class="list-group-item list-group-item-action text-dark ">Mobile : {{ $order->address->phone }}</a>
                  <a href="javascript:void(0);" class="list-group-item list-group-item-action text-dark ">Address 
                    : {{ $order->address->address }},{{ $order->address->city }},{{ $order->address->state }}-{{ $order->address->zip_code }}</a>
                </div>
              </div>
            </div>
            <div class="col-lg-6 mb-4 mb-xl-0">
                ...
                <table class="table">
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    <td>{{ $item->product->name }}
                      <span class="badge bg-label-warning me-1 mx-2">
