        ...
        <div class="row">
            <div class="col-lg-12">
                <form action="" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-lg-8 pr--40 pr_md--5 pr_sm--5">
                                ...
                                {{-- <form action="checkout.html#"> --}}
                                    ...
                                    <div class="half-input-wrapper">
                                        ...
                                        <div class="single-input">
                                            ...
                                            <input id="l-name" name="last_name" type="text" required>
                                        </div>
                                    </div>
<!--                                     <div class="single-input">
                                        <label for="comp">Company Name (Optional)</label>
                                        <input id="comp" name="company" type="text">
                                    </div>
 -->                                    <div class="single-input">
                                    ...
                                    <div class="single-input">
                                        ...
                                        <input id="street" name="address" type="text" required>
                                    </div>
                                    <div class="single-input">
                                    ...
                                    <div class="single-input">
                                        ...
                                        <input id="zip" name="zip_code" type="text" required>
                                    </div>
                                    <div class="single-input">
                                ...
                                <div class="single-shop-list">
                                    <div class="left-area">
                                        <a href="#" class="thumbnail">
                                            <img src="{{ App\Models\Product::getFirstImage($item->product_id) }}" alt="{{ $item->product->name }}">
                                        </a>
                                        <a href="#" class="title">
                                            {{ $item->product->name }}
                                        </a>
                                        {{$item->variation->variation($item->variation_id)}}
                                    </div>
                                    <span class="price">£{{ number_format($item->variation->variationPrice, 2) }}</span>
                                </div>
                                @php $total += $item->variation->variationPrice * $item->qty; @endphp
                                @endforeach
                                <div class="cottom-cart-right-area">
                                    <div class="order-summary mb--25">
                                        <div class="summary-item">
                                            <span>Subtotal:</span>
                                            <span>£{{ number_format($total, 2) }}</span>
                                        </div>
                                        @php $tax = $total * 0.10; @endphp
                                        {{-- <div class="summary-item">
                                            <span>Tax (10%):</span>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <input type="radio" id="s-option" name="payment_mode" value="1" checked>
